...
BRANCH_NAME=flow_planner_lora
CONFIG_FILE="/root/data/flow_planner_grpo/work_dirs/outputs/pittsburgh_lora/pittsburgh_run2/.hydra/config.yaml"
CKPT_FILE="/root/data/flow_planner_grpo/work_dirs/outputs/pittsburgh_lora/pittsburgh_run2/latest.pth"
